...
{
    public partial class ProductsCertificates : System.Web.UI.Page
    {
        ...
        protected void AddToCart(object sender, EventArgs e)
        {
            if (Session["id"] != null)
            {
                ...
                cmd.CommandText = "Insert into [cart](total_price,product_amount,Email,p_name, p_link)values(@Tprice,@amt,@email,@pName,@link)";
