<%@ Page Title="" Language="C#" MasterPageFile="~/ProductManagerMaster.Master" AutoEventWireup="true" CodeBehind="ResourceManagerUploadProductDetails.aspx.cs" Inherits="DigitalRepository.UploadProductDetails" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <!-- Page for the resource/product manager to upload product -->
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="line">
        <a class="textB" href="ResourceManagerUploadProductDetails.aspx"> رفع المنتجات </a>
        <label class ="textB">&lt</label>
        <a class="textC">رفع منتج جديد </a>
        <i class="fa-solid fa-arrow-up-from-bracket icon" ></i>
    </div>

    <div>
      <p style="text-align:center; font-size:50px; color:darkslategrey">رفع منتج جديد</p>
    </div>    
