<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProductsCertificates.aspx.cs" Inherits="DigitalRepository.ProductsCertificates" %>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">

    <!-- Products page specifically for the products of type cirtificate template -->
...
<%--                <asp:Image ID="Image1" runat="server" Height="168px" ImageUrl='<%# Eval("p_picture") %>' Width="237px" ImageAlign="Middle" />--%>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conString %>" SelectCommand="SELECT * FROM [Product] where (p_type LIKE N'تصاميم شهادات')"></asp:SqlDataSource>
