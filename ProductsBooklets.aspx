<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProductsBooklets.aspx.cs" Inherits="DigitalRepository.ProductsBooklets" %>

<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">

    <!-- Products page specifically for the products of type booklet/pamphlet -->
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="line">
        ...
        <a class="textC">بروشورات وكتيبات</a>
...
<%--                <asp:Image ID="Image1" runat="server" Height="168px" ImageUrl='<%# Eval("p_picture") %>' Width="237px" ImageAlign="Middle" />--%>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conString %>" SelectCommand="SELECT * FROM [Product] where (p_type LIKE N'بروشورات وكتيبات')"></asp:SqlDataSource>
