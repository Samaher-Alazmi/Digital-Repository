<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProductsMagazines.aspx.cs" Inherits="DigitalRepository.ProductsMagazines" %>
...
<%--                <asp:Image ID="Image1" runat="server" Height="168px" ImageUrl='<%# Eval("p_picture") %>' Width="237px" ImageAlign="Middle" />--%>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:conString %>" SelectCommand="SELECT * FROM [Product] where (p_type LIKE N'مجلات تعليمية')"></asp:SqlDataSource>
         </div>
</asp:Content>
